...
import { Event, EventCategory, RecurrenceType } from '../../types/Event';
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center">
                    ...
                    <input
                      ...
                      min={1}
                      max={99}
                      className="block w-16 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 sm:text-sm"
                      disabled={mode === 'view'}
                    />
                    <span className="ml-2">
